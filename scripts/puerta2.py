#SERVIDOR
###Este script nos creará un socket que estrá escuchando peticiones de los clientes sobre el puerto 10002 cuando el usuario seleciona el Departamento de Ciencias.
